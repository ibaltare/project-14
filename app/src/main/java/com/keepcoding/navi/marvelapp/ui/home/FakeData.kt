...
object FakeData {
    fun getFakeHeroes() = listOf<Hero>(
        ...
        Hero(id = 1, name = "hulk","https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Hulk_%282540708438%29.jpg/480px-Hulk_%282540708438%29.jpg",true),
        ...
        Hero(id = 1, name = "superman","https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Hulk_%282540708438%29.jpg/480px-Hulk_%282540708438%29.jpg",true),
